...
CREATE TABLE ClassFees(
	classFeesId VARCHAR(10) NOT NULL,
	classId VARCHAR(10) NOT NULL,	
	year3 YEAR NOT NULL,
	month1 INT(2) NOT NULL,	
	CONSTRAINT FOREIGN KEY(classId)REFERENCES Class1(classId)
	ON DELETE CASCADE ON UPDATE CASCADE, 	
	CONSTRAINT PRIMARY KEY(classFeesId)	 		
);

CREATE TABLE ClassFeesPavement(
	classFeesId VARCHAR(10) NOT NULL,
	studentId VARCHAR(10) NOT NULL,
	datePay DATE NOT NULL,
	CONSTRAINT FOREIGN KEY(studentId)REFERENCES Student(studentId)
	ON DELETE CASCADE ON UPDATE CASCADE, 	
	CONSTRAINT FOREIGN KEY(classFeesId)REFERENCES ClassFees(classFeesId)
	ON DELETE CASCADE ON UPDATE CASCADE, 	
	CONSTRAINT PRIMARY KEY(classFeesId,studentId)	 		
);
